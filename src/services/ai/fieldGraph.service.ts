...
const FIELD_DEFS: FieldDef[] = [
  ...
  },
  {
    ...
    aiGenerationAllowed: false,
    prompt:
      "What is the card owner's date of birth? It is required to create the card, must be provided by the owner, and cannot be inferred or generated by AI. Please use YYYY-MM-DD.",
...
export function nextActionableField(fields: AiCardField[], selectedNavIds: string[]): AiCardField | null {
  ...
  const requiredOrder = ['fullName', 'email', 'dob', 'company']
